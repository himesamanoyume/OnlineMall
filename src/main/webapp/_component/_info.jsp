...
<aside class="info-container">
    <div id="info-container-inner" class="info-container-inner">
        ...
        <div class="info-link">
            ...
            <div id="search" class="searchButton">
        ...
        <div class="info-link">
            ...
            <div id="info-github" class="link-button" onclick="window.open('https://github.com/himesamanoyume')">
                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512" width="20px" height="40px">
                    <title>博主Github</title>
            ...
            <div id="info-bilibili" class="link-button" onclick="window.open('https://space.bilibili.com/2256304')">
